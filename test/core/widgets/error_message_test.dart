...
void main() {
  ...
  group('Estrutura', () {
    ...
    testWidgets(
      'deve exibir a mensagem informada',
          (tester) async {
        await _pumpErrorMessage(
          tester,
    ...
    testWidgets(
      'deve renderizar o container da mensagem',
          (tester) async {
        await _pumpErrorMessage(
          tester,
          message: 'Erro.',
  ...
  group('Estados', () {
    ...
    testWidgets(
      'deve renderizar quando a mensagem for informada',
          (tester) async {
        await _pumpErrorMessage(
          tester,
          message: 'Erro.',
    ...
    testWidgets(
      'não deve renderizar quando a mensagem for nula',
          (tester) async {
        await _pumpErrorMessage(
          tester,
          message: null,
    ...
    testWidgets(
      'não deve renderizar quando a mensagem estiver vazia',
          (tester) async {
        await _pumpErrorMessage(
          tester,
          message: '',
  ...
  group('Conteúdo', () {
    ...
    testWidgets(
      'deve atualizar o texto quando a mensagem mudar',
          (tester) async {
        await _pumpErrorMessage(
          tester,
          message: 'Erro 1',
