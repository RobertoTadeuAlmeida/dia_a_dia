...
abstract final class AppKeys {
  ...
  static const primaryButtonIcon = Key('primary_button_icon');
  ...
  static const successMessageIcon = Key('success_message_icon');
  static const successMessageText = Key('success_message_text');
}
